...
const buildPrompt = (inputs: PodcastFormInputs): string => {
  ...
  return `
    ...
    **Tus Instrucciones:**
    1.  **Primero, crea una sección "Intro" de 1 a 3 minutos.** Debe ser una introducción cálida y profesional para contextualizar.
    ...
    6.  **En la sección de "Cierre", incluye estos puntos:**
        ...
        *   Invitación a seguir a la "escuela de diseño" y las redes o webs del invitado/a.
        *   Llamada a la acción: suscribirse al canal de YouTube y compartir el contenido.
    ...
    **Intro (1-3 minutos)**
    1. Reflexión inicial del anfitrión (${hostName}) sobre su rol como "${hostRole}".
    2. Presentación de ${guestName}, destacar la importancia de su "hit" ("${guestHit}") en ${specialization}.

    **${section1} (10-15 minutos)**
    1. Orígenes de ${guestName} en "${section1}", conectándolo con su proyecto "${guestHit}".
    2. Perspectiva de ${hostName} desde su experiencia como ${hostRole} sobre este tema.
    ...
    **${section2} (15-20 minutos)**
    ...
    2. Anécdota o lección aprendida de ${hostName} desde su rol de "${hostRole}".
    ...
    **Cierre (1-2 minutos)**
    ...
    2. Llamada a la acción: "No olviden seguir a la escuela de diseño y a ${guestName} en sus redes".
    3. Recordatorio: "Suscríbanse a nuestro canal de YouTube y compartan si les gustó".
    `;
};
